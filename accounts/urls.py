...
from .views import RegisterView, RequestPasswordResetEmail, PasswordTokenCheckAPI, SetNewPasswordAPI, IntrestListCreateView, GoogleSocialAuthView
...
urlpatterns = [
    ...
    path('social/google-register/', GoogleSocialAuthView.as_view(), name='google-register'),
