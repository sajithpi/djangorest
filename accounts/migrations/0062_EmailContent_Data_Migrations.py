...
def seed_packages(apps, schema_editor):
    ...
    EmailTemplate.objects.create(subject='Welcome to {{company_name}}', content=welcome_email_content, type='Free')
    EmailTemplate.objects.create(subject='Your account verification email', content=otp_verification_email_content, type='Paid')
