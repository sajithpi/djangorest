...
def seed_packages(apps, schema_editor):
    ...
    reset_password = """<p>Password Reset</p><h2>Password Reset 💖</h2><p>Dear <strong>{{username}}</strong> 👋,</p><p>🔒 Click the link below to reset your password:{{reset_link}}</p><p>🔑 Reset Password</p><p>Best regards, 💕 </p><p>{{company_name}} 💑 </p>"""
