    ...
    def get(self, request):
        try:
            ...
            for chat in chats:
                ...
                user_chat['sender_profile_pic'] = '/'+str(chat.sender.profile_picture) if chat.sender.profile_picture else None
                user_chat['received_user'] = chat.receiver.user.username
                user_chat['received_user_profile_photo'] = '/'+str(chat.receiver.profile_picture) if chat.receiver.profile_picture else None
